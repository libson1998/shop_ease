        ...
        builder: (context, state) {
          if (state is HomeSuccessState) {
            int listCount = state.products
                .where((product) => product.purchaseCompleted == true)
                .length;
            return SafeArea(
                child: Column(
                  mainAxisAlignment: listCount == 0 ? MainAxisAlignment
                  ...
                  children: [
                    ...
                    listCount != 0
                      ...
                      children: [
                        ...
                        ListViewWidget(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return Padding(
                              ...
                              child: productList.purchaseCompleted
                                  ? Column(
                                children: [
                                  Padding(
                        ...
                        : const Center(
                      child: Text("Empty Purchase History!"),
                    ),
                    SizedBox()
                  ],
                ));
